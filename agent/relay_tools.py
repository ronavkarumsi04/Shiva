"""Core NeMo Relay adapter for Shiva tool execution."""
    ...
    try:
        ...
        if (
            ...
            logger.warning(
                ...
                "returning the Shiva tool result",
                exc_info=True,
            )
...
def _run_awaitable(value: Any) -> Any:
    ...
    raise RuntimeError(
        "Synchronous Shiva Relay tool execution cannot run on an active event-loop thread"
    )
