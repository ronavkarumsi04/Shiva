...
def build_turn_context(
    ...
    *,
    ...
    # Tag log records on this thread with the session ID for ``shiva logs``.
    ...
    if (
        ...
        # Shiva only initiates compaction in "shiva" mode (#36801).
        _codex_native_auto = (
        ...
        if _preflight_deferred:
            ...
            logger.info(
                "Skipping Shiva preflight compression for codex app-server "
                "(mode=%s); Shiva will not start thread compaction here.",
    ...
    if agent._memory_manager:
        ...
        # to surface it. Rendered by Shiva (via _emit_status), so it always
