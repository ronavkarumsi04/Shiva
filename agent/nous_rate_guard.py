...
(3 SDK retries x 3 Shiva retries), and every one of those calls counts
...
def _state_path() -> str:
    ...
    try:
        ...
        base = os.path.join(os.path.expanduser("~"), ".shiva")
...
def is_genuine_nous_rate_limit(
    *,
    ...
    MiMo, Shiva, ...) behind one endpoint.  A 429 can mean either:
