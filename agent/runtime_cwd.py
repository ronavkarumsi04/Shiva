...
_SESSION_CWD: ContextVar = ContextVar("SHIVA_SESSION_CWD", default=_UNSET)
...
def resolve_context_cwd() -> Path | None:
    ...
    # configured path is otherwise honored verbatim — including the Shiva
    # source tree itself, which is a legitimate workspace when the user is
    # developing Shiva (per-surface policy for fallback-picked directories
