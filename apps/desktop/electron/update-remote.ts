 ...
 *
 * A public install can end up with `origin=git@github.com:NousResearch/shiva-agent.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/NousResearch/shiva-agent.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/nousresearch/shiva-agent'
