...
// by main.ts (`setBackgroundThrottling` driven by the merged `shiva:active-work`
...
// (the "Shiva idles at 20% CPU while minimized" bug). The preload path is
...
// conversation started by the "Hey Shiva" wake word has NO preceding click,
