 ...
 * startShiva() re-throw the cached error without re-attempting the connect —
...
/**
 * Whether a startShiva() failure should latch into `backendStartFailure`.
 ...
 * Every subsequent `getConnection`/`api` call re-runs `startShiva`, re-emits
