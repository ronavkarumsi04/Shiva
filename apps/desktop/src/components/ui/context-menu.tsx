...
export const SHIVA_CONTEXT_MENU_TRIGGER_ATTR = 'data-shiva-context-menu-trigger'

function ContextMenuTrigger({ ...props }: React.ComponentProps<typeof ContextMenuPrimitive.Trigger>) {
  return (
    <ContextMenuPrimitive.Trigger data-slot="context-menu-trigger" {...props} data-shiva-context-menu-trigger="" />
  )
}
