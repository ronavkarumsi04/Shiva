    ...
    host: {
      ...
      requestProfile: async (_route, method) =>
        method === 'profiles.list'
          ? { profiles: [{ name, ui_meta: { 'shiva-bots': { chat: 'owner-chat' } } }] }
          : { sessions: [] },
    ...
    requestForBot: async (_bot, method) => method === 'profiles.list'
      ? {
          profiles: [{
            ...
            ui_meta: { 'shiva-bots': { pinned: true } }
          }]
        }
      : {},
...
test('behavior: remote default never opens the same-name local chat', async () => {
  ...
  const context = {
    ...
    host: {
      ...
      request: async () => ({ profiles: [{ name: 'default', ui_meta: { 'shiva-bots': { chat: 'this-device-chat' } } }] }),
      notify: () => undefined,
