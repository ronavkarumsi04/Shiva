...
test('generated protocol uses shiva profile list, not the invalid profiles plural', () => {
  assert.match(source, /run `shiva profile list` for the LIVE/)
  assert.doesNotMatch(source, /run `shiva profiles list` for the LIVE/)
})
