...
const POPOUT_STORAGE_KEY = 'shiva.desktop.composerPopout.zones.v1'
const POPOUT_GESTURES_ENABLED_STORAGE_KEY = 'shiva.desktop.composerPopout.gesturesEnabled'
...
const LEGACY_ENABLED_KEY = 'shiva.desktop.composerPopout.enabled'
const LEGACY_POSITION_KEY = 'shiva.desktop.composerPopout.position'
