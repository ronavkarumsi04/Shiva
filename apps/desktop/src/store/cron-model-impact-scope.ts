...
function identityForConnection(connection: ShivaConnection | null): string {
  if (!connection) {
    return ''
  }
...
export function syncCronModelImpactConnection(connection: ShivaConnection | null): void {
