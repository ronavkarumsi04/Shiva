...
export interface PetInfo {
  ...
  // the Shiva "run" activity state uses the in-place running row).
 ...
 * SHIVA_HOME — so every pet RPC carries this. The gateway no-ops it for the
 ...
 */
const ROAM_KEY = 'shiva.desktop.pet-roam.v1'
