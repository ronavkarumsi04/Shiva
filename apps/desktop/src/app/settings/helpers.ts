...
import type { ConfigFieldSchema, ShivaConfigRecord, ToolsetInfo } from '@/types/shiva'
...
export function getNested(obj: ShivaConfigRecord, path: string): unknown {
  let cur: unknown = obj
 ...
 */
export function clearsEnabledToolsets(prev: ShivaConfigRecord, next: ShivaConfigRecord): boolean {
...
export function voiceFieldVisible(key: string, config: ShivaConfigRecord): boolean {
...
export function setNested(obj: ShivaConfigRecord, path: string, value: unknown): ShivaConfigRecord {
...
function personalityOptions(config: ShivaConfigRecord): string[] {
...
function commandProviderNames(config: ShivaConfigRecord, section: 'tts' | 'stt'): string[] {
