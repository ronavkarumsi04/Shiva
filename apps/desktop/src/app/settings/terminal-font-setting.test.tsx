...
vi.mock('@/shiva', () => ({
  saveShivaConfig: (config: Record<string, unknown>) => mocks.save(config)
}))
...
vi.mock('../hooks/use-config-record', () => ({
  setShivaConfigCache: (config: Record<string, unknown>) => mocks.cache(config),
  useShivaConfigRecord: () => ({ data: mocks.loadedConfig })
}))
