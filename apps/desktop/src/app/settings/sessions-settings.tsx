...
import type { ShivaConfigRecord, SessionInfo } from '@/types/shiva'
...
// / Program Files), which buried any files Shiva wrote there.
function DefaultProjectDirSetting() {
  ...
  useEffect(() => {
    ...
    // / Storybook / non-Electron context `window.shivaDesktop` is
    ...
    const settings = window.shivaDesktop?.settings
