...
import { getLatestSessionMessages, type ProfileScope } from '@/shiva'
...
interface BackgroundSyncParams {
  ...
  refreshShivaConfig: () => Promise<unknown> | unknown
...
export function useBackgroundSync({
  ...
  }, [activeSessionId, freshDraftReady, gatewayState, refreshCurrentModel, refreshShivaConfig])
}
