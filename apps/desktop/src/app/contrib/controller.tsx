...
registry.registerMany([
  ...
  // The agent's write -> see loop: rescan <shiva home>/desktop-plugins
  ...
  // The keybind panel's non-titlebar door (the keyboard icon is gone).
  {
    ...
    data: {
      ...
      run: () => window.dispatchEvent(new CustomEvent('shiva:open-keybinds'))
    } satisfies PaletteContribution
  },
    ...
    >
      <ContribWiring>
        ...
        <div
          ...
          // [data-shiva-glass] rules in styles.css clear them so the tint
