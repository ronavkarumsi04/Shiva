import type { ShivaReviewFile } from '@/global'
...
export function buildReviewFlatList(files: ShivaReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: ShivaReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')
