...
const TAKEOVER_KEY = 'shiva.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which Shiva can't clear via the API — the user
 *  sees exactly what runs instead of Shiva silently deleting their creds. */
