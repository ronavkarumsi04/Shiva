...
import type { ShivaGitBranch } from '@/global'
...
const branchActionLabel = (branch: ShivaGitBranch, copy: BranchActionCopy) => {
...
export function WorktreeDialog() {
  ...
  const [branches, setBranches] = useState<ShivaGitBranch[]>([])
  ...
  const convert = async (branch: ShivaGitBranch) => {
    if (pending || !repoPath || !branch) {
      return
    }
