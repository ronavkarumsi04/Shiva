...
const FOCUS_EVENT = 'shiva:composer-focus'
const INSERT_EVENT = 'shiva:composer-insert'
const ATTACH_IMAGES_EVENT = 'shiva:composer-attach-images'
const INSERT_REFS_EVENT = 'shiva:composer-insert-refs'
const SUBMIT_EVENT = 'shiva:composer-submit'
const VOICE_TOGGLE_EVENT = 'shiva:composer-voice-toggle'
const MODEL_MENU_EVENT = 'shiva:composer-model-menu'
