...
import { type DroppedFile, extractDroppedFiles, SHIVA_PATHS_MIME } from './use-composer-actions'
...
const dragKindOf = (event: ReactDragEvent): DragKind =>
  dragHasAttachments(event.dataTransfer, SHIVA_PATHS_MIME) ? 'files' : null
