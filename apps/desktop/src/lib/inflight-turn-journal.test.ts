...
const STORAGE_KEY = 'shiva.desktop.inflightTurnJournal.v1'
const STORAGE_PREFIX = 'shiva.desktop.inflightTurnJournal.v2:'
const MIGRATION_KEY = 'shiva.desktop.inflightTurnJournal.v2.migrated'
