...
describe('displayPath', () => {
  it('collapses a macOS home prefix to ~', () => {
    expect(displayPath('/Users/brooklyn/www/shiva-agent')).toBe('~/www/shiva-agent')
...
describe('pathLeaf', () => {
  it('returns the last segment', () => {
    expect(pathLeaf('/Users/me/www/shiva-agent')).toBe('shiva-agent')
    expect(pathLeaf('~/www/shiva-agent')).toBe('shiva-agent')
