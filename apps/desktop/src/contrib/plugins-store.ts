 ...
 * `<shiva home>/desktop-plugins/*` disk door — incl. agent-written ones),
...
const DECISIONS_KEY = 'shiva.desktop.pluginDecisions.v2'
const LEGACY_DISABLED_KEY = 'shiva.desktop.disabledPlugins.v1'
