 ...
 * plugins resolve `@shiva/plugin-sdk` through the vite alias; RUNTIME-loaded
...
const GLOBALS = {
  __SHIVA_PLUGIN_SDK__: sdk,
  __SHIVA_REACT__: React,
  __SHIVA_REACT_JSX__: jsxRuntime,
  __SHIVA_REACT_JSX_DEV__: jsxDevRuntime
} as const
...
export function sdkImportMap(): Record<string, string> {
  cached ??= {
    '@shiva/plugin-sdk': shimUrl('__SHIVA_PLUGIN_SDK__'),
    'react/jsx-dev-runtime': shimUrl('__SHIVA_REACT_JSX_DEV__'),
    'react/jsx-runtime': shimUrl('__SHIVA_REACT_JSX__'),
    react: shimUrl('__SHIVA_REACT__')
  }
