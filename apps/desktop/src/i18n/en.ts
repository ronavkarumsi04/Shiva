...
export const en: Translations = {
  ...
  boot: {
    ready: 'Shiva Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Shiva settings',
      loadingSessions: 'Loading recent sessions',
      retryingRemoteBackend: 'Reconnecting to the remote Shiva backend…',
      startingDesktopConnection: 'Starting desktop connection',
      startingShivaDesktop: 'Starting Shiva Desktop…'
    },
    errors: {
      backgroundExited: 'Shiva background process exited.',
      backgroundExitedDuringStartup: 'Shiva background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Shiva backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateShiva: 'Update Shiva',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Shiva Desktop.',
    ...
    native: {
      ...
      inputBody: 'Shiva is waiting for your response.',
      turnDoneTitle: 'Shiva finished',
      turnDoneBody: '',
  ...
  sendDiagnostics: {
    ...
    failedHint:
      'You can also run `shiva debug share --nous` from a terminal, or `shiva debug share --local` to print the report without uploading.',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Shiva defaults?',
    ...
    plugins: {
      ...
      agent: {
        title: 'Agent plugins',
        blurb:
          'Plugins you installed into the Shiva backend — tools, skills, MCP servers, hooks, and slash commands. Portable ones are Agent Plugins packages (skills + MCP bundles that work in other agents too). Toggles apply to new sessions.',
        ...
        updateBackendToManage: 'Update the Shiva backend to manage this plugin from Desktop.',
      ...
      installModal: {
        ...
        agentTargetLocal: profile => `Installs into the ${profile} backend (~/.shiva/plugins/)`,
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Shiva is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Shiva asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Shiva was in the background.'
        },
        turnError: {
          label: 'Turn failed',
        ...
        plugin: {
          ...
          description: 'A desktop plugin sent a notification while Shiva was in the background.'
        }
      },
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Shiva follow your system setting.',
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and Shiva can react to yours.',
      tipsTitle: 'In-App Tips',
      tipsDesc:
        'A small bubble pointing at one part of the app, shown occasionally while idle and by Shiva when it helps. Closing one retires it for good.',
      tipsReset: (count: number) => `Bring back ${count} closed ${count === 1 ? 'tip' : 'tips'}`,
      toursTitle: 'Guided Tours',
      toursDesc: 'Let Shiva walk you through the app, dimming the screen and spotlighting each step.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Shiva is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Shiva, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      heading: 'Shiva Desktop',
      version: value => `Version ${value}`,
      versionUnavailable: 'Version unavailable',
      bundleOutOfSync: 'App build out of date',
      bundleOutOfSyncDesc:
        'The Shiva runtime was updated, but the desktop app itself is still an older build — new interface features (like Bot Mode) will be missing until it updates. Run the update below to rebuild the app. If that doesn\u2019t clear this warning, reinstall from the latest desktop installer.',
      ...
      automaticUpdatesDesc:
        'Shiva checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Shiva configuration...',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening Shiva.',
    ...
    connections: {
      ...
      intro: 'Manage this device and every Shiva gateway it can reach through remote, SSH, or Cloud connections.',
      stagedNote:
      ...
      updateSkippedCloud: 'Managed by Shiva Cloud',
      kindLocal: 'Local',
      kindRemote: 'Remote gateway',
      kindCloud: 'Shiva Cloud',
      kindSsh: 'SSH',
      kindLocalDesc: 'The Shiva runtime managed by this app.',
      kindRemoteDesc: 'A Shiva gateway reachable over HTTP(S) — LAN, Tailscale, or the internet.',
      kindCloudDesc: 'A hosted instance discovered through your Shiva Cloud account.',
      kindSshDesc: 'A Shiva install reached over SSH.',
      labelTitle: 'Name',
      ...
      headersDesc:
        'Sent with every HTTP and WebSocket request to this gateway — for access proxies such as Cloudflare Access (CF-Access-Client-Id / CF-Access-Client-Secret). Values are stored encrypted. Headers Shiva manages (Authorization, Cookie, Host…) are ignored.',
      ...
      cloudAddHint:
        'Tip: signing in under Shiva Cloud above discovers your agents automatically — use this form only to register a known instance URL by hand.',
    ...
    gateway: {
      ...
      intro:
        'Local by default. Use remote when this app should drive a Shiva backend elsewhere. Gateway connections are machine-level; profiles are discovered from the gateways you connect.',
      envOverrideTitle: 'Environment variables are controlling this desktop session.',
      envOverrideDesc:
        'Unset SHIVA_DESKTOP_REMOTE_URL and SHIVA_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      modeTitle: 'Connection mode',
      localTitle: 'Local gateway',
      localDesc: 'Start a private Shiva backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote Shiva backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'Shiva Cloud',
      cloudDesc: 'Sign in once to Shiva Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'Shiva Cloud',
      cloudSignIn: 'Sign in to Shiva Cloud',
      cloudSignedIn: 'Signed in to Shiva Cloud',
      cloudNeedsSignIn: 'Sign in to Shiva Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your Shiva Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'Shiva Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of Shiva Cloud',
      cloudSignedOutMessage: 'Cleared the Shiva Cloud session.',
      ...
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /shiva.',
      ...
      restartingMessage: 'Shiva Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Shiva ${version}` : ''}`,
      ...
      sshDesc:
        'Shiva is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshShivaPathTitle: 'Shiva path (optional)',
      sshShivaPathDesc: 'Full path to the remote shiva binary. Blank = auto-detect.',
      sshShivaPathPlaceholder: 'auto-detect',
      sshTestConnection: 'Test SSH',
      sshConnect: 'Connect',
      sshButtonsHint: 'Save applies on the next launch. Connect reconnects now.',
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — Shiva found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — Shiva runs ssh non-interactively.',
      sshErrHostKey:
        'The host key has CHANGED since you last connected. Verify this is expected, then run ssh-keygen -R <host> and reconnect.',
      sshErrNotInstalled:
        'Shiva is not installed on the remote host. Install it there (curl -fsSL https://shiva-agent.nousresearch.com/install.sh | sh) or set the Shiva path.',
      sshErrPlatform:
        'Unsupported remote platform. Shiva Desktop SSH mode supports Linux, macOS, and Windows remote hosts.',
      sshErrTimeout: 'SSH connection timed out. The host may be unreachable or asleep.',
      sshErrUpdateRequired: 'Update Shiva on the remote host before connecting with Desktop SSH.',
    ...
    mcp: {
      ...
      deepLinkDescription:
        'A link asked to add this MCP server to Shiva. Review the exact configuration below — it comes from the link, not from Shiva.',
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Shiva runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point Shiva at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
  ...
  skills: {
    ...
    skillArchivedMessage: 'Restorable via shiva curator restore.',
    hub: {
  ...
  starmap: {
    ...
    emptyDesc: 'As Shiva builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Shiva to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Shiva to generate pets.',
      backgroundHint: 'You can close this — Shiva will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Shiva desktop' },
    ...
    shivaActiveSessions: (version, count) => `Shiva ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@shiva:example.org' },
  ...
  profiles: {
    ...
    remoteOverride: {
      ...
      description: 'Sessions in this profile will run on the remote Shiva you point it at, instead of this computer.',
      urlLabel: 'Remote address',
      urlPlaceholder: 'https://shiva.example.com',
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Shiva environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    modelImpact: {
      ...
      saveFailed: 'Shiva did not save that model change.',
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Shiva will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Shiva backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Shiva. Files, git repos, and worktrees stay untouched.',
      ...
      worktreeStaleBackend:
        'Update the Shiva backend to create worktrees over this remote connection — it predates the git worktree API.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Shiva...',
    placeholderReconnecting: 'Reconnecting to Shiva…',
    ...
    attachUrlDesc: 'Shiva will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Shiva to open PR',
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Shiva…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Shiva…',
    ...
    unsupportedMessage: 'This version of Shiva can’t update itself from inside the app.',
    ...
    manualBody: 'You installed Shiva from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Shiva will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Shiva desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Shiva updater takes over in its own window and reopens Shiva automatically when it’s done. Please don’t reopen Shiva yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Shiva reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Shiva reopens on its own.',
    errorTitle: 'Update didn’t finish',
    errorBody: 'No worries — nothing was lost. You can try again now.',
    blockerTitle: 'Close local previews to update Shiva?',
    blockerBody:
      'Shiva needs to stop these local previews before updating. This will not modify or delete your files.',
    foreignBlockerTitle: 'Close other processes to update Shiva',
    foreignBlockerBody:
      'Shiva can’t safely close these processes automatically. Close the app, terminal, or service that owns each one, then try the update again.',
    mixedBlockerBody:
      'Shiva can close the local previews listed below. Other processes must be closed manually before the update can continue.',
  ...
  install: {
    ...
    oneTimeTitle: 'Shiva needs a one-time install',
    ...
    setupChoiceTitle: 'Set up Shiva Desktop',
    setupChoiceDesc:
      'Connect this app to a Shiva gateway you already run, or install Shiva locally on this computer.',
    connectExistingTitle: 'Connect to existing Shiva',
    ...
    installLocalTitle: 'Install Shiva locally',
    installLocalDesc: 'Download Shiva, create its Python environment, and run the backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart Shiva Desktop and try again.',
    remoteSetupTitle: 'Connect to existing Shiva',
    remoteSetupDesc: 'Enter your gateway URL. Shiva Desktop will detect whether it needs a token or browser sign-in.',
    remoteUrlTitle: 'Gateway URL',
    remoteUrlDesc: 'Use the base URL of the Shiva gateway, including https:// when remote.',
    remoteUrlPlaceholder: 'https://gateway.example.com/shiva',
    probing: 'Detecting gateway authentication...',
    probeError: 'Could not reach that Shiva gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
    ...
    settingUpTitle: 'Setting up Shiva Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Shiva CLI or desktop instance is running. Stop any running Shiva instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Shiva Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Shiva is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Shiva…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Shiva',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Shiva at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Shiva connects automatically',
    ...
    authorizeThere: 'Authorize Shiva there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Shiva there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Shiva Desktop v${version}`,
      backendVersion: version => `Backend v${version}`,
      clientLabel: version => `client v${version}`,
      connectionSsh: host => `SSH: ${host}`,
      connectionRemote: host => `Remote: ${host}`,
      connectionCloud: host => `Cloud: ${host}`,
      connectionCloudTooltip: host => `Shiva Cloud · ${host}`,
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Shiva will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Shiva is restarting...',
      askRestart: 'Ask Shiva to restart the server',
      lookingRestart: taskId => `Shiva is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Shiva is working in the background. Watch the preview console for progress.',
      ...
      blankPageBody: 'Type an address above to browse, or ask Shiva to open a page.',
      finishedRestarting: message => `Shiva finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Shiva could not restart the server.',
      stillWorking:
        'Shiva is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Shiva is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Shiva gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.shiva/config.yaml). Shiva won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Shiva needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Shiva needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Shiva Desktop to use Save Image.',
    restartToSaveImages: 'Restart Shiva Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `shiva gateway` running?'
    }
  },
  ...
  tips: {
    ...
    items: {
      ...
      skills: {
        title: 'Teach it once',
        text: 'Skills are folders of instructions Shiva loads when the work calls for them.'
      },
      messaging: {
        title: 'Shiva away from your desk',
        text: 'Connect Telegram, Discord, Slack and more — same agent, same memory.'
      },
      artifacts: {
        title: 'Everything Shiva made',
      ...
      profiles: {
        ...
        text: 'Each one is its own Shiva — own keys, own memory, own sessions.'
      },
      'composer-mentions': {
