...
export const ar = defineLocale({
  sendDiagnostics: {
    ...
    failedHint:
      'يمكنك أيضاً تشغيل `shiva debug share --nous` من الطرفية، أو `shiva debug share --local` لعرض التقرير دون رفعه.',
  ...
  boot: {
    ready: 'Shiva Desktop جاهز',
    desktopBootFailedWithMessage: message => `فشل تشغيل سطح المكتب: ${message}`,
    steps: {
      connectingGateway: 'جار الاتصال ببوابة سطح المكتب',
      loadingSettings: 'جار تحميل إعدادات Shiva',
      loadingSessions: 'جار تحميل الجلسات الأخيرة',
      retryingRemoteBackend: 'جارٍ إعادة الاتصال بخادم Shiva البعيد…',
      startingDesktopConnection: 'جار بدء اتصال سطح المكتب',
      startingShivaDesktop: 'جار تشغيل Shiva Desktop...'
    },
    errors: {
      backgroundExited: 'خرجت عملية Shiva الخلفية.',
      backgroundExitedDuringStartup: 'خرجت عملية Shiva الخلفية أثناء بدء التشغيل.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage: 'خلفية Shiva أقدم من إصدار سطح المكتب الحالي وقد لا تعمل كما يجب. حدثهما ليتوافقا.',
    updateShiva: 'تحديث Shiva',
    ...
    errors: {
      ...
      methodNotAllowed: 'رفضت خلفية سطح المكتب هذا الطلب (405 Method Not Allowed). جرب إعادة تشغيل Shiva Desktop.',
    ...
    native: {
      ...
      inputBody: 'ينتظر Shiva ردّك.',
      turnDoneTitle: 'أنهى Shiva',
      turnDoneBody: '',
  ...
  settings: {
    ...
    resetConfirm: 'هل تريد إعادة كل الإعدادات إلى افتراضيات Shiva؟',
    ...
    plugins: {
      ...
      blurb:
        'امتدادات واجهة تُحمّل داخل هذا التطبيق — إما مضمّنة مع البناء، أو موضوعة في مجلد desktop-plugins (بما فيها التي يكتبها Shiva). تعطيل الإضافة يفرغها مباشرة ويبقى بعد إعادة التشغيل.',
      count: n => `${n} مثبتة`,
    ...
    notifications: {
      ...
      focusedHint: 'تنبيهات الاكتمال تظهر فقط عندما يكون Shiva في الخلفية.',
      kinds: {
        approval: {
          label: 'يلزم الموافقة',
        ...
        input: {
          label: 'يلزم إدخال',
          description: 'طرح Shiva سؤالا أو يحتاج إلى كلمة مرور أو سر.'
        },
        turnDone: {
          label: 'الرد جاهز',
          description: 'انتهى دور بينما كان Shiva في الخلفية.'
        },
        turnError: {
          label: 'فشل الدور',
    ...
    appearance: {
      ...
      backdropDesc: 'اختيار مقدار مزج خلفية سطح المكتب مع سطح Shiva.',
      ...
      reactionsDesc: 'تفاعلات إيموجي بأسلوب iMessage — تفاعل مع الرسائل، ويمكن لـ Shiva التفاعل مع رسائلك.',
      tipsTitle: 'نصائح داخل التطبيق',
      tipsDesc:
        'فقاعة صغيرة تشير إلى جزء من التطبيق، تظهر أحيانًا أثناء الخمول ومن Shiva عند الحاجة. إغلاق نصيحة يزيلها نهائيًا.',
      tipsReset: count => `استعادة ${count} نصيحة مغلقة`,
      toursTitle: 'جولات إرشادية',
      toursDesc: 'دع Shiva يرشدك في التطبيق، مع تعتيم الشاشة وإبراز كل خطوة.',
      ...
      pet: {
        title: 'حيوان أليف',
        intro:
          'تبنَّ تعويذة petdex متحركة تطفو فوق التطبيق وتتفاعل مع ما يفعله Shiva — تجري أثناء تنفيذ الأدوات، وتحتفل عند النجاح، وتعبس عند الأخطاء.',
        restartHint:
          'تحتاج الحيوانات الأليفة إلى إعادة تشغيل سريعة — بدأ التطبيق العامل قبل إضافة هذه الميزة. أغلق Shiva وأعد فتحه، ثم ارجع إلى هنا.',
        on: 'تشغيل',
        off: 'إيقاف',
        scaleTitle: 'الحجم',
    ...
    fieldDescriptions: {
      ...
      timezone: 'تستخدم عندما يحتاج Shiva إلى سياق الوقت المحلي. اتركها فارغة لاستخدام منطقة النظام.',
      'agent.imageInputMode': 'يتحكم في طريقة إرسال مرفقات الصور إلى النموذج.',
      'agent.maxTurns': 'الحد الأعلى لدورات استدعاء الأدوات قبل أن يوقف Shiva التشغيل.',
      ...
      fileReadMaxChars: 'أقصى عدد أحرف يستطيع Shiva قراءته من ملف واحد في الطلب.',
      'approvals.mode': 'كيف يتعامل Shiva مع الأوامر التي تحتاج موافقة صريحة.',
      ...
      'updates.nonInteractiveLocalChanges':
        'عندما يحدّث Shiva نفسه من التطبيق دون موجه طرفية، احتفظ بتعديلات المصدر المحلية أو تجاهلها.'
    },
    about: {
      heading: 'حول Shiva',
      ...
      bundleOutOfSyncDesc:
        'تم تحديث وقت تشغيل Shiva، لكن تطبيق سطح المكتب نفسه لا يزال إصدارًا قديمًا — لن تظهر ميزات الواجهة الجديدة (مثل Bot Mode) حتى يتم تحديث التطبيق. شغّل التحديث أدناه لإعادة بناء التطبيق. إذا لم يختفِ هذا التحذير، فأعد التثبيت من أحدث مثبّت لسطح المكتب.',
      ...
      automaticUpdatesDesc: 'اسمح لـ Shiva بالتحقق من التحديثات وتثبيتها.',
    ...
    config: {
      ...
      loading: 'جار تحميل إعدادات Shiva...',
    ...
    quickEntry: {
      ...
      enabledDesc: 'استدعِ محرّرا صغيرا من أي مكان باختصار عام وأرسل طلبا دون فتح Shiva.',
    ...
    gateway: {
      ...
      intro:
        'يشغّل Shiva Desktop بوابة محلية خاصة افتراضياً. استخدم بوابة بعيدة عندما تريد أن يتحكم هذا التطبيق بخلفية Shiva تعمل مسبقاً على جهاز آخر أو خلف وكيل موثوق. اتصالات البوابة إعداد على مستوى الجهاز؛ ويتم اكتشاف الملفات الشخصية من البوابات المتصلة.',
      envOverrideTitle: 'متغيرات البيئة تتحكم في جلسة سطح المكتب هذه.',
      envOverrideDesc: 'أزل SHIVA_DESKTOP_REMOTE_URL و SHIVA_DESKTOP_REMOTE_TOKEN لاستخدام الإعداد المحفوظ أدناه.',
      localTitle: 'بوابة محلية',
      localDesc: 'تشغيل خلفية Shiva خاصة على localhost. هذا هو الافتراضي ويعمل دون اتصال.',
      remoteTitle: 'بوابة بعيدة',
      remoteDesc:
        'صل واجهة سطح المكتب هذه بخلفية Shiva بعيدة. البوابات المستضافة تستخدم OAuth أو اسم مستخدم وكلمة مرور، والبوابات الذاتية قد تستخدم رمز جلسة.',
      remoteUrlTitle: 'رابط البوابة البعيدة',
      remoteUrlDesc: 'الرابط الأساسي لخلفية لوحة التحكم البعيدة. يمكن استخدام بادئات مسار مثل /shiva.',
      ...
      restartingMessage: 'سيعيد Shiva Desktop الاتصال باستخدام الإعدادات المحفوظة.',
      savedMessage: 'تم الحفظ للتشغيل القادم.',
      connectedTo: (baseUrl, version) => `متصل بـ ${baseUrl}${version ? ` · Shiva ${version}` : ''}`,
    ...
    mcp: {
      ...
      deepLinkDescription:
        'طلب رابط إضافة خادم MCP هذا إلى Shiva. راجع الإعدادات الكاملة أدناه — فهي قادمة من الرابط وليست من Shiva.',
    ...
    providers: {
      ...
      intro: 'سجل الدخول باشتراكك دون نسخ مفتاح API. يشغّل Shiva تسجيل الدخول من المتصفح لك داخل التطبيق.',
      connected: 'متصل',
      collapse: 'طي',
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'أعد تشغيل Shiva لاستخدام الحيوانات الأليفة — الخادم الخلفي أقدم من هذه الميزة.',
    ...
    generatePet: {
      ...
      staleBackend: 'حدّث Shiva لتوليد الحيوانات الأليفة.',
      backgroundHint: 'يمكنك إغلاق هذا — سيُعلِمك Shiva عند الانتهاء.',
    ...
    shivaActiveSessions: (version, count) => `Shiva ${version} لديه ${count} جلسة نشطة`,
  ...
  profiles: {
    ...
    remoteOverride: {
      ...
      description: 'ستعمل جلسات هذا الملف الشخصي على خادم Shiva البعيد الذي تحدده، بدلاً من هذا الجهاز.',
  ...
  cron: {
    ...
    modelImpact: {
      ...
      saveFailed: 'لم يحفظ Shiva تغيير النموذج هذا.',
    ...
    emptyDescNew: 'أنشئ مهمة مجدولة لتشغيل Shiva تلقائيا.',
    ...
    createDesc: 'اضبط مهمة يشغلها Shiva تلقائيا.',
    nameLabel: 'الاسم',
    namePlaceholder: 'مثال: الملخص الصباحي',
    promptLabel: 'الرسالة',
    promptPlaceholder: 'ماذا تريد من Shiva أن يفعل؟',
  ...
  sidebar: {
    ...
    projects: {
      ...
      deleteConfirm: 'هذا يزيل المشروع المحفوظ من Shiva. تبقى الملفات ومستودعات git وأشجار العمل دون تغيير.',
      ...
      worktreeStaleBackend:
        'حدِّث خادم Shiva لإنشاء أشجار العمل عبر هذا الاتصال البعيد — فهو أقدم من واجهة git worktree.',
  ...
  composer: {
    ...
    placeholderStarting: 'جار بدء Shiva...',
    placeholderReconnecting: 'جار إعادة الاتصال...',
    placeholderFollowUp: 'اكتب متابعة...',
    newSessionPlaceholders: ['اسأل Shiva عن شيء...', 'اطلب من Shiva تنفيذ مهمة...', 'ابدأ محادثة جديدة...'],
    ...
    urlHintPre: 'سيقرأ Shiva الرابط ضمن السياق.',
    attach: 'إرفاق',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'اطلب من Shiva فتح PR',
  ...
  updates: {
    stages: {
      ...
      pydeps: 'جار الإنهاء...',
      update: 'جار تحديث Shiva...',
      rebuild: 'جار إعادة بناء تطبيق سطح المكتب...',
      restart: 'جار إعادة تشغيل Shiva...',
      done: 'اكتمل التحديث',
    ...
    unsupportedMessage: 'لا يمكن لهذا الإصدار من Shiva تحديث نفسه من داخل التطبيق.',
    ...
    availableBody: 'إصدار جديد من Shiva جاهز للتثبيت.',
    availableTitleBackend: 'يتوفر تحديث للواجهة الخلفية',
    availableBodyBackend: 'إصدار أحدث من واجهة Shiva الخلفية المتصلة جاهز للتثبيت.',
    ...
    manualBody: 'لقد ثبّتت Shiva من سطر الأوامر، لذا تُجرى التحديثات من هناك أيضا. الصق هذا في طرفيتك:',
    manualPickedUp: 'سيلتقط Shiva الإصدار الجديد في المرة التالية التي تشغّله فيها.',
    guiSkewTitle: 'تحديث تطبيق سطح المكتب',
    guiSkewBody:
      'تم تحديث الواجهة الخلفية، لكن حزمة تطبيق سطح المكتب هذه لم تتغير. حدّث أو أعد تثبيت تطبيق Shiva لسطح المكتب (ملف AppImage / ‎.deb / ‎.rpm) لمطابقته.',
    copy: 'نسخ',
    copied: 'تم النسخ',
    done: 'تم',
    applyingBody:
      'يتولّى مُحدِّث Shiva المهمة في نافذته الخاصة ويعيد فتح Shiva تلقائيا عند الانتهاء. الرجاء عدم إعادة فتح Shiva بنفسك أثناء التحديث.',
    applyingBodyBackend:
      'تطبّق الواجهة الخلفية البعيدة التحديث وستعيد التشغيل. يعيد Shiva الاتصال تلقائيا عند عودتها.',
    applyingClose: 'ستُغلق هذه النافذة أثناء تشغيل التحديث، ثم يعيد Shiva فتح نفسه تلقائيا.',
    errorTitle: 'لم يكتمل التحديث',
    errorBody: 'لا داعي للقلق — لم يُفقد شيء. يمكنك إعادة المحاولة الآن.',
    blockerTitle: 'إغلاق المعاينات المحلية لتحديث Shiva؟',
    blockerBody: 'يحتاج Shiva إلى إيقاف هذه المعاينات المحلية قبل التحديث. لن يؤدي ذلك إلى تعديل ملفاتك أو حذفها.',
    foreignBlockerTitle: 'أغلق العمليات الأخرى لتحديث Shiva',
    foreignBlockerBody:
      'لا يمكن لـ Shiva إغلاق هذه العمليات تلقائيًا بأمان. أغلق التطبيق أو الطرفية أو الخدمة التي تشغّل كل عملية، ثم حاول التحديث مرة أخرى.',
    mixedBlockerBody:
      'يمكن لـ Shiva إغلاق المعاينات المحلية المدرجة أدناه. يجب إغلاق العمليات الأخرى يدويًا قبل متابعة التحديث.',
  ...
  install: {
    ...
    oneTimeTitle: 'يحتاج Shiva إلى تثبيت لمرة واحدة',
    ...
    settingUpTitle: 'جار إعداد وكيل Shiva',
    finishingTitle: 'جار الإنهاء',
    failedDesc:
      'فشلت إحدى خطوات التثبيت. على Windows، قد يحدث هذا إذا كان هناك نسخة أخرى من Shiva CLI أو تطبيق سطح المكتب قيد التشغيل. أوقف أي نسخ Shiva قيد التشغيل، ثم أعد المحاولة. تحقق من التفاصيل أدناه أو من سجل سطح المكتب للحصول على النص الكامل.',
    activeDesc:
      'هذا إعداد لمرة واحدة. يقوم مثبّت Shiva بتنزيل التبعيات وتهيئة جهازك. ستتخطى عمليات التشغيل اللاحقة هذه الخطوة.',
  ...
  onboarding: {
    headerTitle: 'لنُعِدّ لك Shiva Agent',
    headerDesc: 'اربط مزوّد نماذج لبدء المحادثة. معظم الخيارات تتطلب نقرة واحدة.',
    preparingInstall: 'يُكمل Shiva التثبيت. عادة ما يستغرق ذلك أقل من دقيقة في أول تشغيل.',
    starting: 'جار بدء Shiva...',
    ...
    recommended: 'موصى به',
    connected: 'متصل',
    featuredPitch: 'اشتراك واحد، أكثر من 300 نموذج متقدم — الطريقة الموصى بها لتشغيل Shiva',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'مستضاف ذاتيا',
        description:
          'وجّه Shiva إلى نقطة نهاية محلية أو مستضافة ذاتيا متوافقة مع OpenAI (vLLM، llama.cpp، Ollama، إلخ).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'يفتح صفحة تحقق في المتصفح — يتصل Shiva تلقائياً',
      loopback: 'يفتح المتصفح لتسجيل الدخول — يتصل Shiva تلقائياً',
    ...
    authorizeThere: 'صرّح لـ Shiva هناك.',
    copyAuthCode: 'انسخ رمز التفويض وألصقه أدناه.',
    pasteAuthCode: 'ألصق رمز التفويض',
    reopenAuthPage: 'إعادة فتح صفحة التفويض',
    autoBrowser: provider => `فتحنا ${provider} في المتصفح. صرّح لـ Shiva هناك وسيتم الاتصال تلقائياً دون نسخ أو لصق.`,
  ...
  preview: {
    ...
    largeBody: (label, size) => `حجم ${label} هو ${size}. سيعرض Shiva أول 512 KB فقط.`,
    ...
    web: {
      ...
      tryAgain: 'إعادة المحاولة',
      restarting: 'جار إعادة تشغيل Shiva...',
      askRestart: 'اطلب من Shiva إعادة تشغيل الخادم',
      lookingRestart: taskId => `يبحث Shiva عن خادم معاينة لإعادة تشغيله (${taskId})`,
      restartingTitle: 'جار إعادة تشغيل خادم المعاينة',
      restartingMessage: 'يعمل Shiva في الخلفية. راقب كونسول المعاينة لمتابعة التقدم.',
      ...
      blankPageBody: 'اكتب عنوانًا في الأعلى للتصفح، أو اطلب من Shiva فتح صفحة.',
      finishedRestarting: message => `أنهى Shiva إعادة تشغيل خادم المعاينة${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'تعذّر على Shiva إعادة تشغيل الخادم.',
      stillWorking:
        'لا يزال Shiva يعمل، لكن لم تصل نتيجة إعادة التشغيل بعد. قد يكون أمر الخادم قيد التشغيل في المقدمة.',
  ...
  desktop: {
    ...
    handoff: {
      ...
      timedOut: 'انتهت المهلة في انتظار البوابة. هل `shiva gateway` قيد التشغيل؟'
    }
  },
  errors: {
  ...
  tips: {
    ...
    items: {
      ...
      skills: {
        ...
        text: 'المهارات مجلدات من التعليمات يحمّلها Shiva عندما يقتضي العمل ذلك.'
      },
      messaging: {
        title: 'Shiva بعيدًا عن مكتبك',
        text: 'اربطه بـ Telegram وDiscord وSlack وغيرها — الوكيل نفسه والذاكرة نفسها.'
      },
      artifacts: {
        title: 'كل ما صنعه Shiva',
      ...
      profiles: {
        ...
        text: 'كل واحد منها Shiva مستقل — مفاتيحه وذاكرته وجلساته الخاصة.'
      },
      'composer-mentions': {
