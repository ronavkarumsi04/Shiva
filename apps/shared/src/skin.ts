/**
 * Canonical Shiva skin — the theme SDK's cross-surface contract.
 *
 * A skin is authored once as YAML in `$SHIVA_HOME/skins/<name>.yaml` (or a
 * built-in), resolved by the Python skin engine (`shiva_cli/skin_engine.py`),
 ...
 *   • CLI     → `shiva_cli/skin_engine` → prompt_toolkit / Rich styles (Python)
 *
