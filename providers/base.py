...
def _profile_user_agent() -> str:
    """Return a ``shiva-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from shiva_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"shiva-cli/{_ver}"
    except Exception:
        return "shiva-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # shiva-cli UA so the catalog endpoint is reachable.
