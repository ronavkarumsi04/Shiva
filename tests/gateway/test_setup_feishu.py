"""Tests for _setup_feishu() in shiva_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("shiva_cli.config.save_env_value", side_effect=mock_save), \
         patch("shiva_cli.config.get_env_value", side_effect=mock_get), \
         patch("shiva_cli.config.remove_env_value", side_effect=mock_remove), \
         patch("shiva_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("shiva_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("shiva_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("shiva_cli.cli_output.print_header"), \
         patch("shiva_cli.cli_output.print_info"), \
         patch("shiva_cli.cli_output.print_success"), \
         patch("shiva_cli.cli_output.print_warning"), \
         patch("shiva_cli.cli_output.print_error"), \
