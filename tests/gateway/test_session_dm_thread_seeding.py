...
def store(tmp_path, monkeypatch):
    ...
    ~/.shiva/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at shiva_state import time, before pytest's SHIVA_HOME monkeypatch
    fires — the autouse fixture's SHIVA_HOME override doesn't help here.)
    """
    import shiva_state
