...
from shiva_cli.plugins import VALID_HOOKS, PluginManager
...
# tests/shiva_cli/test_lifecycle.py::test_finalize_session_closes_core_before_plugin_export.
@patch("shiva_cli.lifecycle.invoke_hook")
@patch("shiva_cli.lifecycle.finalize_session")
