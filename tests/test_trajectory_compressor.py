...
def test_import_loads_env_from_shiva_home(tmp_path, monkeypatch):
    home = tmp_path / ".shiva"
    home.mkdir()
    (home / ".env").write_text("OPENROUTER_API_KEY=from-shiva-home\n", encoding="utf-8")
    ...
    assert os.getenv("OPENROUTER_API_KEY") == "from-shiva-home"
