...
The unit tests in tests/shiva_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned shiva-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/shiva")
from shiva_cli.service_manager import S6ServiceManager
