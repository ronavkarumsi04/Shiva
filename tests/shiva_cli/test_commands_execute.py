...
Every ``CommandDef`` with ``execute`` set must:
  * name a key that exists in :data:`shiva_cli.slash_exec.EXECUTORS`, and
...
from shiva_cli.commands import COMMAND_REGISTRY, resolve_command
from shiva_cli.slash_exec import (
    EXECUTORS,
    CommandContext,
    CommandReply,
    execute_command,
