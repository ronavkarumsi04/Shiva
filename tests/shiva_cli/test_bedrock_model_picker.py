...
Covers the three paths changed by fix/bedrock-provider-model-ids-live-discovery:
  ...
  2. list_authenticated_providers() Section 2 (SHIVA_OVERLAYS) — bedrock
...
# ---------------------------------------------------------------------------
# 2. list_authenticated_providers() — bedrock via SHIVA_OVERLAYS (Section 2)
# ---------------------------------------------------------------------------
...
class TestBedrockOverlayRegistration:
    """bedrock entry in SHIVA_OVERLAYS is correctly configured."""

    def test_bedrock_overlay_exists(self):
        from shiva_cli.providers import SHIVA_OVERLAYS
        assert "bedrock" in SHIVA_OVERLAYS
