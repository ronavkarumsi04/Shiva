...
class TestGetCopilotModelContext:
    ...
    @patch("shiva_cli.models.fetch_github_model_catalog", return_value=_SAMPLE_CATALOG)
    ...
    @patch("shiva_cli.models._urlopen_model_catalog_request")
    ...
    @patch("shiva_cli.models.fetch_github_model_catalog", return_value=[])
