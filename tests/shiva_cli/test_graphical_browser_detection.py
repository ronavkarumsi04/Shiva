"""Tests for `_can_open_graphical_browser()` in shiva_cli.auth.

Guards the fix for the May 2026 report where `shiva auth add xai-oauth`
...
from shiva_cli.auth import _can_open_graphical_browser
