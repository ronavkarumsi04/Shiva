...
from shiva_cli import process_identity
...
def test_control_plane_argv_is_not_a_gateway():
    ...
    serve = "C:\\Shiva\\.venv\\Scripts\\python.exe -m shiva_cli.main serve --host 127.0.0.1"
    run = "C:\\Shiva\\.venv\\Scripts\\python.exe -m shiva_cli.main gateway run"
...
def test_control_plane_classifier_is_token_based_not_substring():
    ...
    py = "C:\\Shiva\\.venv\\Scripts\\python.exe -m shiva_cli.main"
...
def test_pause_skips_cold_start_plan_when_desktop_owns_lifecycle(monkeypatch):
    ...
    monkeypatch.setattr(
        shiva_gateway, "find_windows_gateway_services", lambda **_k: []
    )
