"""Tests for the interactive session browser (`shiva sessions browse`).
...
from shiva_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """shiva sessions browse should be parseable."""
