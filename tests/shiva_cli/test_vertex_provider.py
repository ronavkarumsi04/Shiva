...
def test_vertex_registered_in_provider_registry():
    """PROVIDER_REGISTRY (shiva_cli.auth) is what agent/auxiliary_client.py's
...
def test_vertex_registered_in_shiva_overlays():
    """shiva_cli.providers.get_provider("vertex") backs
