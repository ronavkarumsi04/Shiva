"""Tests for the ``shiva prompt-size`` diagnostic (issue #34667)."""
...
from shiva_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(shiva_home, memory_text="", user_text=""):
    mem_dir = shiva_home / "memories"
...
def _seed_skill(shiva_home, name, description):
    skill_dir = shiva_home / "skills" / "demo" / name
