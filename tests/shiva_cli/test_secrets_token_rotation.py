"""Tests for `shiva secrets bitwarden token` / `shiva secrets onepassword token`.
...
from shiva_cli import onepassword_secrets_cli as op_cli
from shiva_cli import secrets_cli as bw_cli
