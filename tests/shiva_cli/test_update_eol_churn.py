"""Regression: ``shiva update`` should take a managed checkout off autocrlf=true.
...
``shiva update`` has to repair them.
...
from shiva_cli.update_cmd import _normalize_managed_eol
