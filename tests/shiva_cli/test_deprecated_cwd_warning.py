...
def _write_env(monkeypatch, tmp_path, content):
    ...
    shiva_home.mkdir()
    (shiva_home / ".env").write_text(content, encoding="utf-8")
...
class TestDeprecatedCwdWarning:
    ...
    def test_process_environment_does_not_trigger_warning(
        ...
        from shiva_cli.config import warn_deprecated_cwd_env_vars
    ...
    def test_dotenv_read_failure_is_silent(self, monkeypatch, capsys):
        import shiva_cli.config as config_module
