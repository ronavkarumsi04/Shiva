"""Tests for ``shiva approvals suggest`` (shiva_cli/approvals_suggest.py).

Approval history in Shiva is implied, not ledgered: the session DB
...
from shiva_cli.approvals_suggest import (
    Proposal,
    apply_proposals,
    build_proposals,
    derive_glob,
