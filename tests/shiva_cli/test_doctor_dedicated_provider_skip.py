"""Regression: shiva doctor must not run a generic Bearer-auth health
...
with HTTP 404. The dedicated check at shiva_cli/doctor.py already covers
Anthropic with the right headers, so the pluggable profile must be
skipped by `_build_apikey_providers_list()`.

See: NousResearch/shiva-agent#22346
"""
