"""Tests for the specifier module + `shiva kanban specify` CLI surface.
...
from shiva_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `shiva kanban …` argparse surface directly."""
