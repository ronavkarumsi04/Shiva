"""Tests for `shiva chat --safe-mode` isolation."""
...
_VARS = ("SHIVA_SAFE_MODE", "SHIVA_IGNORE_USER_CONFIG", "SHIVA_IGNORE_RULES")
...
def test_cmd_chat_safe_mode_sets_env_before_startup(monkeypatch):
    ...
    def fake_has_provider() -> bool:
        assert os.environ["SHIVA_SAFE_MODE"] == "1"
        assert os.environ["SHIVA_IGNORE_USER_CONFIG"] == "1"
        assert os.environ["SHIVA_IGNORE_RULES"] == "1"
        return True
