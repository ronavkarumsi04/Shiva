"""Tests for the shared byte formatter (shiva_cli.sizefmt).
...
def test_migrated_sites_render_through_the_shared_helper():
    ...
    from shiva_cli.backup import _format_size as backup
    from shiva_cli.checkpoints import _fmt_bytes as checkpoints
    from shiva_cli.doctor import _human_bytes as doctor
