...
The main() function in shiva_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `shiva -c model`
...
def _build_parser():
    """Build a minimal replica of the shiva top-level parser."""
