"""Regression test: shiva update must not load cryptography eagerly."""
...
assert 'shiva_cli.secrets_cli' not in sys.modules, \\
...
"""
    ...
    def test_update_check_no_cryptography(self) -> None:
        """Running shiva update --check should NOT load cryptography._rust."""
        # Write a small script in the repo root so shiva_cli is importable,
...
import shiva_cli.main
from shiva_cli.update_cmd import _cmd_update_check
