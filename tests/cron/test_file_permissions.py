...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("shiva_cli.config.get_config_path", return_value=config_path), \
             patch("shiva_cli.config.ensure_shiva_home"):
    ...
    def test_ensure_shiva_home_sets_0700(self):
        home = Path(self.tmpdir) / ".shiva"
