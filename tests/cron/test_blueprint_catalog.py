...
the shared /blueprint command handler (shiva_cli/blueprint_cmd.py), and
the docs generator. Uses an isolated SHIVA_HOME for anything that touches the
cron job store.
"""
...
class TestRenderers:
    ...
    def test_deeplink_shape(self):
        ...
        assert url.startswith("shiva://blueprint/morning-brief?")
