...
# Resolve the skill's scripts dir across layouts: standalone dev repo (tests/) and shiva-agent
...
_CANDIDATES = [
    ...
    _HERE.parent.parent.parent.joinpath(*_REL),          # shiva-agent (tests/skills/)
]
