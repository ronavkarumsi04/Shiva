"""The `shiva-agent` skill is what a running Shiva knows about itself.

`website/` is never packaged, so an installed Shiva has no local copy of the
user guide; skills ARE synced into `$SHIVA_HOME/skills/`. The skill therefore
...
shipped feature is invisible and the agent answers "Shiva can't do that."
"""
...
SKILL_DIR = REPO / "skills" / "autonomous-ai-agents" / "shiva-agent"
