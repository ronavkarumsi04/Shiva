...
manipulation. Shiva keeps canonical conversation history in state.db and may
...
def fake_homes(tmp_path, monkeypatch):
    """Point SHIVA_HOME at a temp profile dir.

    Uses the real env-var resolution chain (get_shiva_home /
    get_default_shiva_root) instead of monkeypatching private helpers —
    ...
    SHIVA_HOME=<root>/profiles/<name> makes get_default_shiva_root()
