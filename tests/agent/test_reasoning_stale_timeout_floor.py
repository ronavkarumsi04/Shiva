...
thinking phase.  Shiva's default cloud-stream stale detector
(``SHIVA_STREAM_STALE_TIMEOUT`` = 180s) and non-stream detector
(``SHIVA_API_CALL_STALE_TIMEOUT`` = 90s) both fire before the
