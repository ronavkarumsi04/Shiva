"""Session <-> workspace grouping key (shiva_state.workspace_key).

The key is what `shiva sessions list --workspace` groups/filters on. It is a
...
from shiva_state import workspace_key
