...
Verifies that:
 ...
 2. User plugins at $SHIVA_HOME/plugins/model-providers/<name>/ override bundled
...
def _clear_provider_caches():
    ...
    for mod in list(sys.modules.keys()):
        if (
            ...
            or mod.startswith("_shiva_user_provider")
        ):
            del sys.modules[mod]
