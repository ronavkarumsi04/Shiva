...
Keeps the ACP server tests offline: ``ShivaACPAgent._build_model_state``
calls ``shiva_cli.inventory.build_models_payload``, which (without this
...
def _offline_model_inventory(monkeypatch):
    ...
    import shiva_cli.inventory as inventory
