#!/usr/bin/env python3
"""
SWE Runner with Shiva Trajectory Format

A runner that uses Shiva-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Shiva-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Shiva-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Shiva format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Shiva-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Shiva-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Shiva Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Shiva-Agent's built-in execution environments
    and outputs trajectories in Shiva-Agent format.
    """
    ...
    def _convert_to_shiva_format(
        ...
        """
        Convert internal message format to Shiva trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Shiva trajectory format
        trajectory = self._convert_to_shiva_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Shiva trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Shiva Trajectory Format")
    print("=" * 60)
