 ...
 *
 * Values mirror shiva_constants.VALID_REASONING_EFFORTS plus `none`
 * (thinking-off). An empty/unset config value means the Shiva default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown → `medium` (Shiva' default when unset). */
