/**
 * Shiva Dashboard Plugin SDK — typed contract (SPIKE)
 * ====================================================
 *
 * This is the public type surface for ``window.__SHIVA_PLUGIN_SDK__`` and
 * ``window.__SHIVA_PLUGINS__``, the globals the dashboard host exposes to
 ...
 * window.__SHIVA_PLUGIN_SDK__`` because:
 ...
 *
 * Versioning: bump ``ShivaPluginSDK["sdkVersion"]`` (and the
 ...
 *   - Ship as a published ``@shiva/dashboard-plugin-sdk`` types package, or
 ...
 * of calling ``fetch`` with a hand-read ``window.__SHIVA_SESSION_TOKEN__``.
 */
...
// ---------------------------------------------------------------------------
// Registry surface (window.__SHIVA_PLUGINS__)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// SDK surface (window.__SHIVA_PLUGIN_SDK__)
// ---------------------------------------------------------------------------

export interface ShivaPluginSDK {
...
declare global {
  interface Window {
    __SHIVA_PLUGIN_SDK__?: ShivaPluginSDK;
    __SHIVA_PLUGINS__?: PluginRegistry;
  }
}
