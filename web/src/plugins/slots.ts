 ...
 * `window.__SHIVA_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Shiva brand in the top bar
 ...
 *  `window.__SHIVA_PLUGINS__.registerSlot(...)`.
 *
