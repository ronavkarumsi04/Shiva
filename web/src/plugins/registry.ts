 ...
 *
 * Plugins call window.__SHIVA_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__SHIVA_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__SHIVA_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__SHIVA_PLUGIN_SDK__ = {
    ...
    // window.__SHIVA_SESSION_TOKEN__ directly.
    authedFetch,
