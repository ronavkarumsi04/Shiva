 ...
 * `_BUILTIN_DASHBOARD_THEMES` list in `shiva_cli/web_server.py`.
 */
...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "Shiva Teal",
  description: "Classic dark teal — the canonical Shiva look",
  palette: {
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "Shiva Teal (Large)",
  description: "Shiva Teal with bigger fonts and roomier spacing",
