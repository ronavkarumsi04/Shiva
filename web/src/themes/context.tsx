...
const STORAGE_KEY = "shiva-dashboard-theme";
...
const FONT_STORAGE_KEY = "shiva-dashboard-font";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `shiva_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "shiva-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-shiva-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-shiva-theme-font", "true");
