...
export const en: Translations = {
  ...
  status: {
    ...
    updateShivaConfirmMessage:
      "This runs shiva update and restarts the gateway when it finishes. Active sessions keep their prompt cache until then.",
    updateShivaConfirmNow: "Update now",
    updateShivaConfirmTitle: "Update Shiva?",
    updatingShiva: "Updating Shiva…",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update Shiva plugins (`shiva plugins` parity).",
    ...
    removeConfirm: "Remove this plugin from ~/.shiva/plugins/?",
    removeHint: "Only user-installed plugins under ~/.shiva/plugins can be removed.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills found. Skills are loaded from ~/.shiva/skills/",
  ...
  env: {
    ...
    customHint: "Arbitrary environment variables stored in your .env that Shiva doesn't recognise. Use these to inject env vars for skills, MCP servers, or your own tooling.",
  ...
  achievements: {
    hero: {
      ...
      title: "Shiva Achievements",
      subtitle:
        "Collectible Shiva badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning Shiva session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run Shiva more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once Shiva sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "Shiva is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
    ...
    share: {
      ...
      tweet_text: "Just unlocked {tier_part}\"{name}\" in Shiva Agent ☤",
    },
  },
