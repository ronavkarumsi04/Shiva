...
export const tr: Translations = {
  ...
  status: {
    ...
    stopped: "Durduruldu",
    updateShiva: "Shiva'i Güncelle",
    updatingShiva: "Shiva güncelleniyor…",
  ...
  pluginsPage: {
    ...
    headline:
      "Shiva eklentilerini keşfedin, yükleyin, etkinleştirin ve güncelleyin (`shiva plugins` ile eşdeğer).",
    ...
    removeConfirm: "Bu eklenti ~/.shiva/plugins/ içinden kaldırılsın mı?",
    removeHint: "Yalnızca ~/.shiva/plugins altındaki kullanıcı tarafından yüklenmiş eklentiler kaldırılabilir.",
  ...
  skills: {
    ...
    filters: "Filtreler",
    noSkills: "Yetenek bulunamadı. Yetenekler ~/.shiva/skills/ adresinden yüklenir",
  ...
  env: {
    ...
    customHint: ".env dosyanızda saklanan ve Shiva'in tanımadığı rastgele ortam değişkenleri. Bunları beceriler, MCP sunucuları veya kendi araçlarınız için ortam değişkenleri eklemek için kullanın.",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Gerçek oturum geçmişinden kazanılan, koleksiyonluk Shiva rozetleri. Bilinen ama henüz tamamlanmamış başarılar Keşfedildi olarak gösterilir; Gizli başarılar ilk eşleşen davranış görünene kadar saklı kalır.",
      scan_subtitle:
        "Shiva oturum geçmişi taranıyor. Büyük geçmişlerde ilk tarama 5–10 saniye sürebilir.",
    },
    actions: {
      rescan: "Yeniden tara",
    },
    stats: {
      ...
      latest: "En son",
      latest_hint_empty: "Shiva'i daha çok çalıştır",
      none_yet: "Henüz yok",
    },
    state: {
      unlocked: "Açıldı",
    ...
    guide: {
      ...
      secret_body:
        "Sırlar, tetikleyicilerini saklı tutar. Shiva ilgili bir sinyal gördüğünde kart Keşfedildi durumuna geçer ve gereksinimini gösterir.",
      scan_status_header: "Tarama durumu",
      scan_status_body:
        "Shiva yerel geçmişi bir kez tarıyor; sonra kartlar otomatik olarak görünür. Birkaç saniye sürmesi normaldir, hiçbir şey takılmadı.",
