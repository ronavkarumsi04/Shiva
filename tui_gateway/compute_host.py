    ...
    def __init__(
        ...
        *,
        ...
        self._heartbeat_secs = (
            ...
            else float(os.environ.get("SHIVA_COMPUTE_HOST_HEARTBEAT_SECS") or "15")
        )
    ...
    def _run_real_turn(self, frame: dict[str, Any]) -> None:
        ...
        try:
            ...
            try:
                ...
                shiva_undo.on_user_message_appended(session["session_key"])
            except Exception:
                pass
            try:
...
def _default_workers() -> int:
    try:
        return max(2, int(os.environ.get("SHIVA_TUI_RPC_POOL_WORKERS") or "8"))
    except (TypeError, ValueError):
        return 8


def run_host(stdin: Any = None, stdout: Any = None) -> None:
    os.environ["SHIVA_COMPUTE_HOST_CHILD"] = "1"
    ...
    host.emit(
        {
            ...
            "cwd": os.getcwd(),
            "shiva_home": os.environ.get("SHIVA_HOME", ""),
        }
    )
