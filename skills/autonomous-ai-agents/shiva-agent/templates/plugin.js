/**
 * Shiva desktop plugin template. Save as:
 *   <shiva home>/desktop-plugins/<id>/plugin.js   (folder name == id)
 * where <shiva home> is ~/.shiva by default, or ~/.shiva/profiles/<name>
 * when running a named profile (`shiva -p <name>`). Run `shiva doctor` (or
 ...
 * Only these imports resolve: @shiva/plugin-sdk, react, react/jsx-runtime.
 */

import { cn, haptic, host, Tip, usePluginI18n, useValue } from '@shiva/plugin-sdk'
