...
Registry of record: `shiva_cli/commands.py` (`COMMAND_REGISTRY`) — every
...
/snapshot [sub]          Create/restore Shiva config+state snapshots (CLI)
