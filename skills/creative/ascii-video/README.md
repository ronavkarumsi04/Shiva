...
Built for [Shiva Agent](https://github.com/NousResearch/shiva-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/shiva-agent/skills/creative/ascii-video`](https://github.com/NousResearch/shiva-agent/tree/main/skills/creative/ascii-video) via PR.
