...
def _state_dir() -> Path:
    ...
    # Default: $SHIVA_HOME/watcher-state/, falling back to ~/.shiva/watcher-state/.
    shiva_home = os.environ.get("SHIVA_HOME") or str(Path.home() / ".shiva")
    return Path(shiva_home) / "watcher-state"
