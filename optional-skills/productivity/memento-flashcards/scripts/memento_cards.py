...
Data file: $SHIVA_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_SHIVA_HOME = Path(os.environ.get("SHIVA_HOME", Path.home() / ".shiva"))
DATA_DIR = _SHIVA_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
