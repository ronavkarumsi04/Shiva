...
# by /etc/cont-init.d/01-shiva-setup (installed by the Dockerfile). This
...
# on the pre-s6 contract "entrypoint.sh sets up state then execs shiva"
...
echo "[shiva] WARNING: docker/entrypoint.sh is a deprecated shim under " \
