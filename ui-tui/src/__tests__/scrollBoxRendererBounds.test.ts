...
import { Box, renderSync, ScrollBox, type ScrollBoxHandle, Text } from '@shiva/ink'
import React, { useLayoutEffect, useRef } from 'react'
import { describe, expect, it, vi } from 'vitest'

import SourceBox from '../../packages/shiva-ink/src/ink/components/Box.js'
import SourceScrollBox from '../../packages/shiva-ink/src/ink/components/ScrollBox.js'
import SourceText from '../../packages/shiva-ink/src/ink/components/Text.js'
import type { DOMElement } from '../../packages/shiva-ink/src/ink/dom.js'
import Output from '../../packages/shiva-ink/src/ink/output.js'
import { scrollFastPathStats as sourceScrollFastPathStats } from '../../packages/shiva-ink/src/ink/render-node-to-output.js'
import { renderSync as renderSourceSync } from '../../packages/shiva-ink/src/ink/root.js'
