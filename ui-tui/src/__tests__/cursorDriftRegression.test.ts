 ...
 *
 * Symptom: in `shiva --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@shiva/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using shiva --tui and as i type multiline my caret at the end will often ' +
