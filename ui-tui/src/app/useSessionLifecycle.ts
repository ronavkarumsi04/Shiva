...
import type { ScrollBoxHandle } from '@shiva/ink'
import { evictInkCaches } from '@shiva/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.SHIVA_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
