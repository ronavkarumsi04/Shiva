import type { BillingBlock, UsageModelData } from '@shiva/shared/billing'
import type { ShivaSkin } from '@shiva/shared/skin'

import type { SessionInfo, SlashCategory, SubagentStatus, Usage } from './types.js'

/** The cross-surface skin contract (canonical shape in `@shiva/shared`).
 *  Includes the paired light_colors/dark_colors overlays from #20379. */
export type GatewaySkin = ShivaSkin
...
// Wire shapes now live in @shiva/shared for reuse by TypeScript clients.
export type {
  BillingAutoReload,
  BillingBlock,
  BillingCardInfo,
