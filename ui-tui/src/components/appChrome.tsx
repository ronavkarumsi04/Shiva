import { Box, type ScrollBoxHandle, stringWidth, Text } from '@shiva/ink'
...
export function StatusRule({
  ...
  // Dev-only readout (SHIVA_DEV_CREDITS). The server omits the key entirely unless the
  ...
  // Dev-gated readout (SHIVA_DEV_CREDITS), lowest priority,
