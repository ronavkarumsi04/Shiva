...
await build({
  ...
  // Skip the prebuilt @shiva/ink bundle and inline the source instead:
  ...
  alias: { '@shiva/ink': resolve(root, 'packages/shiva-ink/src/entry-exports.ts') },
...
// the `node` token, leaving a broken interpreter). The shiva_cli launcher
