 ...
 * across theme x background scenes to <tmpdir>/shiva-tui-visual/tui-visual.html,
...
import { Box, renderSync, Text } from '@shiva/ink'
...
// The regenerated slate light_colors block from shiva_cli/skin_engine.py
// (relight recipe: vivid hue-preserved accents, airy capped-saturation text,
// darker calm dims).

const info: SessionInfo = {
  cwd: '/Users/brooklyn/www/shiva-agent',
...
const setup = (bgHex: string) => {
  process.env.SHIVA_TUI_BACKGROUND = bgHex
  resetOverlayState()
  resetUiState()
}
