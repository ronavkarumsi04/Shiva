      ...
      let
        ...
        excludedDirs =
          ...
          jsWorkspaceTopDirs ++ [
            ...
            "nix"
            # Skills are shipped via SHIVA_BUNDLED_SKILLS /
            # SHIVA_OPTIONAL_SKILLS (see shiva-agent.nix), not via the
            ...
            # __init__.py) shipped via symlinks + SHIVA_BUNDLED_LOCALES
            # / SHIVA_OPTIONAL_MCPS, not via the wheel. Excluding them
