# nix/overlays.nix — Expose pkgs.shiva-agent for external NixOS configs
#
...
# `pkgs.shiva-agent`, `nix build .#default`, and the NixOS module's
...
{ inputs, ... }:
{
  flake.overlays.default = final: _: {
    shiva-agent = inputs.self.packages.${final.stdenv.hostPlatform.system}.default;
  };
}
