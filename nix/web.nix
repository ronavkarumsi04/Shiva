# nix/web.nix — Shiva Web Dashboard (Vite/React) frontend build
{ shivaNpmLib, ... }:
shivaNpmLib.buildNpmPackage {
  dirs = [
    "web"

    # @shiva/shared ships as a file: workspace dep of web, so its source
  ...
  buildPhase = ''
    ...
    # outDir in vite.config.ts points to ../shiva_cli/web_dist for the
