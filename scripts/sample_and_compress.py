...
DEFAULT_DATASETS = [
    ...
    "NousResearch/shiva-agent-megascience-sft1",
    "NousResearch/Shiva-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/Shiva-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-shiva-agent"
]
