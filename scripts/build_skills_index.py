#!/usr/bin/env python3
"""Build the Shiva Skills Index — a centralized JSON catalog of all skills.
...
`shiva skills search/install` can use it without hitting the GitHub API.
...
# Ensure SHIVA_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Shiva Skills Index...", flush=True)
