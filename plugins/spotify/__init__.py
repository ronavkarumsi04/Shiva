...
``_check_spotify_available()`` — when the user has not run ``shiva auth
spotify``, the tools remain registered (so they appear in ``shiva
...
The Spotify auth flow (``shiva auth spotify``), CLI plumbing, and docs
