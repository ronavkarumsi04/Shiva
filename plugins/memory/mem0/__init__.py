...
Configuration
-------------
Secret (lives in $SHIVA_HOME/.env or the environment):
...
Behavioral settings (live in $SHIVA_HOME/mem0.json, set via `shiva memory
setup`):
  ...
  agent_id           — Agent identifier (default: shiva)
...
def _load_config() -> dict:
    """Load config from env vars, with $SHIVA_HOME/mem0.json overrides.
    ...
    config = {
        ...
        "agent_id": os.environ.get("MEM0_AGENT_ID", "shiva"),
        "oss": {},
    }
    ...
    config_path = get_shiva_home() / "mem0.json"
...
class Mem0MemoryProvider(MemoryProvider):
    ...
    def save_config(self, values, shiva_home):
        """Write config to $SHIVA_HOME/mem0.json."""
        import json
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        #   1. Operator-configured MEM0_USER_ID (env or $SHIVA_HOME/mem0.json) —
        ...
        self._agent_id = self._config.get("agent_id", "shiva")
