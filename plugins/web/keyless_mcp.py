...
two endpoints so a fresh Shiva install with **zero web credentials** still
...
def provider_tier(name: str) -> str:
    ...
    ``shiva tools`` picker's Free/Paid rows). ``free`` forces the keyless
    ...
    try:
        ...
        return {
            ...
            "error": (
                ...
                "backend via `shiva tools` for reliable service."
            ),
        }
    ...
    try:
        ...
        return {
            ...
            "error": (
                ...
                "via `shiva tools` for reliable service."
            ),
        }
