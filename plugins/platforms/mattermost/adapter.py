...
required — uses aiohttp which is already a Shiva dependency.
...
def interactive_setup() -> None:
    ...
    ``shiva_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Shiva delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # shiva_cli/setup.py::_setup_mattermost function.
