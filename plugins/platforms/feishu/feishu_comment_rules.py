...
Config: ~/.shiva/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.shiva/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_shiva_home()`` helper (SHIVA_HOME-aware and
...
RULES_FILE = get_shiva_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_shiva_home() / "feishu_comment_pairing.json"
