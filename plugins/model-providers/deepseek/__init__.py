...
the contract that subsequent turns echo it back; combined with how Shiva
...
2026-07-24.  Use ``deepseek-v4-flash`` or ``deepseek-v4-pro``; Shiva remaps
the retired IDs in ``shiva_cli.model_normalize``.
"""
...
def _model_supports_thinking(model: str | None) -> bool:
    ...
    before requests leave Shiva, so they are not listed here.
    """
