...
# When the user hasn't picked a reasoning effort, Shiva passes
...
# ON at this effort — matching the "medium (default)" that Shiva' /reasoning
...
class UpstageProfile(ProviderProfile):
    ...
    def build_api_kwargs_extras(
        ...
        # Map Shiva' effort vocabulary onto Solar's accepted set via the
