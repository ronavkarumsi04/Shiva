...
request omits ``thinking``.  Shiva' ``reasoning_config = {"enabled": False}``
...
:meth:`ZaiProfile.build_api_kwargs_extras` translates the Shiva reasoning
...
(per Z.AI / BigModel docs).  Shiva' richer effort scale is collapsed onto
...
def _glm_5_2_reasoning_effort(
    ...
    """Map Shiva reasoning effort onto GLM's native vocabulary.
