...
```bash
python3 -m pyfiglet "SHIVA" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=SHIVA&font=Slant" | boxes -d stone
```
