...
| | |
|---|---|
| Source | Optional — install with `shiva skills install official/web-development/page-agent` |
...
- User wants **Shiva itself to drive a browser** → use Shiva' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
