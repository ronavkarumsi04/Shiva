...
| | |
|---|---|
| Source | Optional — install with `shiva skills install official/creative/pixel-art` |
...
```python
import sys
sys.path.insert(0, "/home/teknium/.shiva/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.shiva/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Shiva installs package this)
