...
| | |
|---|---|
| Source | Optional — install with `shiva skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | Shiva Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
| License | MIT |
...
# $SHIVA_OSINT_CACHE/icij/ (default: ~/.cache/shiva-osint/icij/).
...
# Set SHIVA_OSINT_UA=your-app/1.0 (your@email) to identify yourself
