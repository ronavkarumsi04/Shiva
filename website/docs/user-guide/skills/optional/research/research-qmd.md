...
| | |
|---|---|
| Source | Optional — install with `shiva skills install official/research/qmd` |
...
| Related skills | [`obsidian`](/docs/user-guide/skills/bundled/note-taking/note-taking-obsidian), [`shiva-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-shiva-agent), [`arxiv`](/docs/user-guide/skills/bundled/research/research-arxiv) |
...
Shiva Agent via the native MCP client. This is the preferred
...
Then configure Shiva Agent to connect via HTTP:
