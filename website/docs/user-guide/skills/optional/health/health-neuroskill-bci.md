...
| | |
|---|---|
| Source | Optional — install with `shiva skills install official/health/neuroskill-bci` |
...
Connect Shiva to a running [NeuroSkill](https://neuroskill.com/) instance to read
