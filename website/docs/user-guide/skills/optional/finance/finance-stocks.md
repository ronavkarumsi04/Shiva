...
| | |
|---|---|
| Source | Optional — install with `shiva skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Shiva Agent |
| License | MIT |
...
```
SCRIPT=~/.shiva/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.shiva/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
