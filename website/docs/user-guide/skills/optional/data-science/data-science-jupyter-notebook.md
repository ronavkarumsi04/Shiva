...
| | |
|---|---|
| Source | Optional — install with `shiva skills install official/data-science/jupyter-notebook` |
...
| `execute_code` | One-shot scripts needing shiva tool access (web_search, file ops). Stateless. |
