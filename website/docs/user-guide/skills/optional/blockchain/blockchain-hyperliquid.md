...
| | |
|---|---|
| Source | Optional — install with `shiva skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), Shiva Agent |
| License | MIT |
...
The script reads `${SHIVA_HOME:-~/.shiva}/.env` for two optional defaults:
...
Helper script: `~/.shiva/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.shiva/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `${SHIVA_HOME:-~/.shiva}/.env`.
...
```bash
python3 ~/.shiva/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.shiva/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
