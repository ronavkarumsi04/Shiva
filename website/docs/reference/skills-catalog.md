...
| [`shiva-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-shiva-agent) | Use, configure, theme, extend, and orchestrate Shiva Agent. | `autonomous-ai-agents/shiva-agent` |
...
| [`shiva-agent-skill-authoring`](/docs/user-guide/skills/bundled/software-development/software-development-shiva-agent-skill-authoring) | Author in-repo SKILL.md files: frontmatter and structure. | `software-development/shiva-agent-skill-authoring` |
| [`inspecting-shiva-desktop-dom`](/docs/user-guide/skills/bundled/software-development/software-development-inspecting-shiva-desktop-dom) | Read the live Shiva desktop DOM/CSS over CDP. | `software-development/inspecting-shiva-desktop-dom` |
...
| [`plan`](/docs/user-guide/skills/bundled/software-development/software-development-plan) | Write a markdown plan to .shiva/plans/; no execution. | `software-development/plan` |
