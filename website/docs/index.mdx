...
slug: /
sidebar_position: 0
title: "Shiva Agent Documentation"
...
After installing, run `shiva setup --portal` — one OAuth covers a model plus all four Tool Gateway tools (web search, image generation, TTS, browser). See [Nous Portal](/integrations/nous-portal).
:::
...
| 🔌 **[MCP Integration](/user-guide/features/mcp)**                      | Connect to MCP servers, filter their tools, and extend Shiva safely  |
| 🧭 **[Use MCP with Shiva](/guides/use-mcp-with-shiva)**               | Practical MCP setup patterns, examples, and tutorials                 |
| 🎙️ **[Voice Mode](/user-guide/features/voice-mode)**                    | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with Shiva](/guides/use-voice-mode-with-shiva)** | Hands-on setup and usage patterns for Shiva voice workflows          |
| 🎭 **[Personality & SOUL.md](/user-guide/features/personality)**        | Define Shiva' default voice with a global SOUL.md                    |
...
| 💡 **[Tips & Best Practices](/guides/tips)**                            | Quick wins to get the most out of Shiva                              |
...
- **Built by model trainers** — Created by [Nous Research](https://nousresearch.com), the lab behind Shiva, Nomos, and Psyche. Works with [Nous Portal](https://portal.nousresearch.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [Nous Research](https://nousresearch.com) — the lab behind Shiva, Nomos, and Psyche models
