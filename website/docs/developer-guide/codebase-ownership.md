...
| Model providers & transports | `agent/transports/`, `plugins/model-providers/`, `shiva_cli/models.py` | [Adding Providers](adding-providers.md), [Model Provider Plugins](model-provider-plugin.md), [Provider Runtime](provider-runtime.md) |
...
| CLI | `shiva_cli/` | [Extending the CLI](extending-the-cli.md) |
| Plugins system | `plugins/` | [Build a Shiva Plugin](plugins/index.md) |
...
| Session storage | `shiva_state.py` | [Session Storage](session-storage.md) |
