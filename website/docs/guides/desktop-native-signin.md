...
description: "How the Shiva Desktop app signs in to a gated gateway using your system browser and PKCE — no embedded webview, no session cookies"
---

# Desktop Native Sign-In (RFC 8252)

When the Shiva Desktop app connects to a **gated gateway** (a hosted or
...
For Shiva specifically, native sign-in means:
...
- [Run Shiva with Nous Portal](./run-shiva-with-nous-portal.md)
