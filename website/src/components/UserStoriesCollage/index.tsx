  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          What the Shiva Agent community is actually building. Every tile
          below links to a real post, issue, video, or gist where someone
          describes how they use Shiva &mdash; scraped from X, GitHub, Reddit,
      ...
      <div className={styles.footer}>
        Built something with Shiva?{' '}
        <a
          href="https://github.com/NousResearch/shiva-agent/edit/main/website/src/data/userStories.json"
          target="_blank"
          rel="noopener noreferrer"
        >
