...
Invoked by ``shiva kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Shiva Agent board.
...
def _profile_author() -> str:
    """Mirror of ``shiva_cli.kanban._profile_author``."""
    return (
