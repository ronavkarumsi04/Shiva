"""Relay subscriber for the persisted Shiva shared-metrics slice."""
...
class SharedMetricsSubscriber:
    """Persist validated Shiva counters from Relay lifecycle events."""
    ...
    def __call__(self, event: Any) -> None:
        ...
        with self._lock:
            ...
            try:
                ...
                logger.warning(
                    "Unable to persist the Shiva shared metric: %s",
                    metric_name,
                    exc_info=True,
                )
