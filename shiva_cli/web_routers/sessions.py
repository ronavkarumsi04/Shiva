...
async def search_sessions(
    ...
    try:
        ...
        try:
            ...
            # logs, or another Shiva surface. FTS can't find those unless the
...
async def import_sessions_endpoint(request: Request):
    ...
    restores a whole Shiva backup archive, while this endpoint is scoped to
...
async def get_session_stats(profile: Optional[str] = None):
    """Session-store statistics for the Sessions page (mirrors `shiva sessions stats`).
