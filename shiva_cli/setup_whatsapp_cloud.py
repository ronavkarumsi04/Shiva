...
Entry point: ``shiva whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``shiva_cli/main.py``).
...
Shiva gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures Shiva to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Shiva needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Shiva gateway in another terminal:")
    print("         shiva gateway")
    print()
    ...
    print()
    print("  Docs: https://shiva-agent.nousresearch.com/docs/user-guide/")
