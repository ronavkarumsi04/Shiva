"""Shared curses-based UI components for Shiva CLI.

Used by `shiva tools` and `shiva skills` for interactive checklists.
...
_MENU_NAVIGATION_HANDLER: ContextVar[MenuNavigationHandler | None] = ContextVar(
    "shiva_menu_navigation_handler", default=None
)
_NUMBERED_BACK_ENABLED: ContextVar[bool] = ContextVar(
    "shiva_numbered_back_enabled", default=False
)
...
def _read_numbered_input(prompt_text: str) -> str | _NumberedNavigation:
    ...
    from shiva_cli.pt_input_extras import install_modify_other_keys_aliases
