...
``shiva sessions recover --allow-partial`` normally copies rows through SQL,
...
rows back into a fresh current-schema Shiva session database.
...
# Shiva session ids are timestamps: 20260812_135332_ab12cd. This is the
...
def _cli_supports_recover(binary: str) -> bool:
    ...
    scratch_dir = tempfile.mkdtemp(prefix="shiva-recover-probe-")
