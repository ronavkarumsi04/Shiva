"""Client for uploading ``shiva debug share`` bundles to Nous-internal S3.

This is the opt-in (``--nous``) destination for ``shiva debug share``.
...
NAS_BASE = os.environ.get(
    "SHIVA_DIAGNOSTICS_BASE_URL", "https://portal.nousresearch.com"
)
...
_USER_AGENT = "shiva-agent/debug-share"
