"""
Shiva CLI - Unified command-line interface for Shiva Agent.

Provides subcommands for:
- shiva chat          - Interactive chat (same as ./shiva)
- shiva gateway       - Run gateway in foreground
- shiva gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    can even start — e.g. `shiva setup` on a fresh Pi.
    ...
    shiva_cli/stdio.py::configure_windows_stdio() runs later from the entry
