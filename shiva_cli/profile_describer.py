...
Used by ``shiva profile describe <name> --auto`` and the dashboard's
...
Design notes
------------
- Mirrors the shape of ``shiva_cli/kanban_specify.py``: lazy aux
...
_SYSTEM_PROMPT = """You are a profile-describer for the Shiva Agent kanban board.
...
Rules:
  ...
  - Never write "Shiva Agent profile" or other meta-narration.
    ...
    *,
    ...
    try:
        if canon == "default":
            ...
            profile_dir = Path(get_shiva_home())
        else:
