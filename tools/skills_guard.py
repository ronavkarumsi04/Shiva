...
Trust levels:
  - builtin:   Ships with Shiva. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.shiva/\.env|\~/\.shiva/\.env',
     "shiva_env_access", "critical", "exfiltration",
     "directly references Shiva secrets file"),
    ...
    (r'\.shiva/config\.yaml|\.shiva/SOUL\.md',
     "shiva_config_mod", "critical", "persistence",
     "references Shiva configuration files directly"),
...
# scan. `.skillignore` is the Shiva-native name; `.clawhubignore` is honored
