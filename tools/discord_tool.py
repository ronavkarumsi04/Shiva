...
Only included in the shiva-discord toolset, so it has zero cost
...
def _discord_request(
    ...
    req = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "Shiva-Agent (https://github.com/NousResearch/shiva-agent)",
        },
    )
...
def _capability_disk_cache_path() -> "Path":
    ...
    return get_shiva_home() / "cache" / "discord_capabilities.json"
