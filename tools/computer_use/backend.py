...
class UIElement:
    ...
    # (trycua/cua#1961 — Surface 6 of NousResearch/shiva-agent#47072).
...
class CaptureResult:
    ...
    # trycua/cua#1961 — Surface 7 of NousResearch/shiva-agent#47072).
...
class ActionResult:
    ...
    verify → escalate ladder (NousResearch/shiva-agent#67052). ``ok`` stays
