...
the get_anchored_view / get_messages_around primitives in shiva_state.
...
from shiva_state_common import _RESET_END_REASONS

# Sources that are excluded from session browsing/searching by default.
# Third-party integrations tag their sessions with SHIVA_SESSION_SOURCE=tool;
...
SESSION_SEARCH_SCHEMA = {
    "name": "session_search",
    "description": (
        "Search past Shiva sessions (FTS5 over the local session DB), or read/"
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "profile": {
                "type": "string",
                "description": (
                    "Optional. Read sessions from another Shiva profile's database "
