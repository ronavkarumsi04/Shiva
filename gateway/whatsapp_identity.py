...
def expand_whatsapp_aliases(identifier: str) -> Set[str]:
    ...
    bridge's ``$SHIVA_HOME/whatsapp/session/lid-mapping-*.json`` files,
    ...
    session_dir = get_shiva_dir("platforms/whatsapp/session", "whatsapp/session")
