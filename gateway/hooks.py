...
Hooks are discovered from ~/.shiva/hooks/ directories, each containing:
...
HOOKS_DIR = get_shiva_home() / "hooks"
    ...
    def discover_and_load(self) -> None:
        ...
        for hook_dir in sorted(HOOKS_DIR.iterdir()):
            ...
            try:
                ...
                module_name = f"shiva_hook_{hook_name}"
